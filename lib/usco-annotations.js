...
var BaseHelper = (function (_THREE$Object3D) {
	function BaseHelper(options) {
		...
		_get(Object.getPrototypeOf(BaseHelper.prototype), "constructor", this).call(this, options);
...
var CrossHelper = function CrossHelper(options) {
  ...
  this.centerCross = new THREE.LineSegments(startCrossGeometry, new GizmoLineMaterial({ color: this.color, opacity: opacity, transparent: true }));
...
var AngularDimHelper = function AngularDimHelper(options) {
  ...
  this.startCross = new CrossHelper({ color: 16711680, size: 5 });
  this.startCross.hide();
  this.add(this.startCross);

  this.midCross = new CrossHelper({ color: 255, size: 5 });
  this.midCross.hide();
  this.add(this.midCross);

  this.endCross = new CrossHelper({ color: 65280, size: 5 });
  this.endCross.hide();
...
AngularDimHelper.prototype.setEnd = function (end, object) {
  ...
  if (this.debug) {
    ...
    this.debugHelpers.add(new CrossHelper({ position: offsetStart, color: 16711935 }));
    //this.debugHelpers.add( new CrossHelper({position:this.start,color:0x0000FF} ) );

    this.debugHelpers.add(new CrossHelper({ position: arcCenter, color: 255 }));
    this.debugHelpers.add(new THREE.ArrowHelper(plane.normal, arcCenter, 20, 16711680));
    this.debugHelpers.add(new THREE.ArrowHelper(midToStartDir, this.mid, 20, 16711680));

    this.debugHelpers.add(new THREE.ArrowHelper(paral, this.mid, 20, 16776960));
    this.debugHelpers.add(new THREE.ArrowHelper(endToOffsetStart.clone().normalize(), offsetStart, 20, 16776960));
...
AngularDimHelper.prototype.set = function () {
  ...
  var lineMaterial = new THREE.LineBasicMaterial({ color: this.linesColor, linewidth: 1, depthTest: false, depthWrite: false, renderDepth: 100000000000000000000, opacity: 0.8, transparent: true });
  ...
  mainArrowRight.renderDepth = 100000000000000000000;
  ...
  mainArrowLeft.renderDepth = 100000000000000000000;
...
},{"./AnnotationHelper":12}],12:[function(require,module,exports){
"use strict";
...
},{"../BaseHelper":5}],13:[function(require,module,exports){
"use strict";
...
},{"../CircleHelper":6,"../CrossHelper":7,"../GizmoMaterial":8,"../dimensions/LeaderLineHelper":18,"../dimensions/SizeHelper":19,"./AnnotationHelper":12}],14:[function(require,module,exports){
"use strict";
  ...
  _prototypeProperties(DistanceHelper, null, {
    _computeBasics: {
      ...
      value: function _computeBasics() {
        ...
        if (!start || !end || !startObject || !endObject) {
          return;
...
},{"../CrossHelper":7,"../dimensions/SizeHelper":19,"./AnnotationHelper":12}],15:[function(require,module,exports){
"use strict";
...
},{"../CrossHelper":7,"./AnnotationHelper":12}],16:[function(require,module,exports){
"use strict";
  ...
  _prototypeProperties(ThicknessHelper, null, {
    _computeBasics: {
      value: function _computeBasics() {
        ...
        if (!entryPoint || !exitPoint || !object) {
          return;
    ...
    _setupVisuals: {
      ...
      value: function _setupVisuals() {
        ...
        this.entryPointHelper = new CrossHelper({ color: 16711680 });
        this.exitPointHelper = new CrossHelper({ color: 65280 });
...
},{"../BaseHelper":5,"../CrossHelper":7,"../dimensions/SizeHelper":19,"./AnnotationHelper":12}],17:[function(require,module,exports){
"use strict";
...
},{"../LabelHelper":9,"./AngularDimensionsHelper.js":11,"./AnnotationHelper.js":12,"./DiameterHelper.js":13,"./DistanceHelper.js":14,"./NoteHelper.js":15,"./ThicknessHelper.js":16,"babel/polyfill":4}],18:[function(require,module,exports){
"use strict";
...
var LeaderLineHelper = (function (BaseHelper) {
  function LeaderLineHelper(options) {
    ...
    var options = Object.assign({}, DEFAULTS, options);
    _get(Object.getPrototypeOf(LeaderLineHelper.prototype), "constructor", this).call(this, options);
    Object.assign(this, options);
  ...
  _inherits(LeaderLineHelper, BaseHelper);
...
},{"../BaseHelper":5,"../CrossHelper":7,"../GizmoMaterial":8,"../LabelHelper":9}],19:[function(require,module,exports){
"use strict";
  ...
  _prototypeProperties(SizeHelper, null, {
    ...
    _setupVisuals: {
      value: function _setupVisuals() {
        ...
        this.offsetStartDebugHelper = new CrossHelper({ color: 16711680 });
        this.offsetMidDebugHelper = new CrossHelper({ color: 255 });
        this.offsetEndDebugHelper = new CrossHelper({ color: 65280 });
...
},{"../BaseHelper":5,"../CrossHelper":7,"../GizmoMaterial":8,"../LabelHelper":9,"../LineHelper":10}]},{},[17])(17)
});
