      ...
      */
      ...
      value: function getTargetBoundsData(targetObject, point) {
        ...
        */
        ...
        var foo = point.clone().sub(objectCenter);
...
var SizeHelper = (function (BaseHelper) {
  function SizeHelper(options) {
    ...
    var DEFAULTS = {
      ...
      up: undefined, //new THREE.Vector3(0,0,1),
  ...
  _prototypeProperties(SizeHelper, null, {
    ...
    _computeLabelAndArrows: {
      ...
      */
      ...
      value: function _computeLabelAndArrows() {},
      writable: true,
      configurable: true
    },
    _setupVisuals: {
      value: function _setupVisuals() {
        ...
        leftArrowHeadSize = rightArrowHeadSize = 1e-11;
        leftArrowHeadWidth = rightArrowHeadWidth = 1e-11;
...
},{"../BaseHelper":5,"../GizmoMaterial":8,"../LabelHelper":9,"../LineHelper":10}]},{},[16])(16)
});