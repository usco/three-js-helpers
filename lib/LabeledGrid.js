...
var LabeledGrid = (function (_THREE$Object3D) {
  function LabeledGrid(width, length, step, upVector, color, opacity, text, textColor, textPosition) {
    ...
    _get(Object.getPrototypeOf(LabeledGrid.prototype), "constructor", this).call(this);
  ...
  _prototypeProperties(LabeledGrid, null, {
    _drawGrid: {
